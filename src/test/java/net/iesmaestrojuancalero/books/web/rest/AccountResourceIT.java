package net.iesmaestrojuancalero.books.web.rest;

import static net.iesmaestrojuancalero.books.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import java.util.*;
import net.iesmaestrojuancalero.books.IntegrationTest;
import net.iesmaestrojuancalero.books.config.Constants;
import net.iesmaestrojuancalero.books.domain.User;
import net.iesmaestrojuancalero.books.repository.AuthorityRepository;
import net.iesmaestrojuancalero.books.repository.UserRepository;
import net.iesmaestrojuancalero.books.security.AuthoritiesConstants;
import net.iesmaestrojuancalero.books.service.UserService;
import net.iesmaestrojuancalero.books.service.dto.AdminUserDTO;
import net.iesmaestrojuancalero.books.service.dto.PasswordChangeDTO;
import net.iesmaestrojuancalero.books.service.dto.UserDTO;
import net.iesmaestrojuancalero.books.web.rest.vm.KeyAndPasswordVM;
import net.iesmaestrojuancalero.books.web.rest.vm.ManagedUserVM;
